...
__all__ = [
    ...
    'all_doctors', 'doctor_details', 'total_patients', 'upcoming_appointments_count', 'pending_appointments_count', 'doctor_patients_count', 'todays_patient', 'doctor_rating_detail', 'last_completed_appointment', 'doctor_general_discussion', 'select_doctor', 'assign_survey', 'update_doctor'
    'get_all_pharmacy_patients', 'get_pharmacy_info', 'add_pt_rx',
    'get_patient_info', 'update_patient','patient_medical_history', 'create_medical_record', 'update_primary_pharmacy', 'update_doctor_by_patient_id',
    'add_user','new_appointments_request', 
    'medication_info',
    'get_user_info_by_id',
